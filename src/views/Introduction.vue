  ...
  <div class="big-idea-container" id="section-2">
    <div class="big-idea">
      <div class="big-idea-wrapper">
        <div class="bulb-container">
          <div class="big-bulb">
            <img src="../assets/thebigidea1.png" alt="" />
          </div>
          ...
          <div class="image">
            <img class="arrow" alt="Arrow" src="../assets/arrow.png" />
          </div>
          <div class="star1">
            <img src="../assets/satagra.png" alt="" />
          </div>
        </div>
      </div>
    </div>
    <div class="intro-block">
      <p class="introduction">
        ...
        <span class="textWrapper">tech Hackathon 1.0</span>
        <span class="star2">
          <img src="../assets/satagra.png" alt="" />
        </span>
      </p>
      <p class="our-tech-hackathon">
